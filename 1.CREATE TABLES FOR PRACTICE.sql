USE [MyStoreDB]
GO
/****** Object:  Table [dbo].[AverageSalaryByDept]    Script Date: 4/12/2023 7:22:58 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 4/12/2023 7:22:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Department]    Script Date: 4/12/2023 7:22:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Employee]    Script Date: 4/12/2023 7:22:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Product]    Script Date: 4/12/2023 7:22:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sales]    Script Date: 4/12/2023 7:22:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SalesDetails]    Script Date: 4/12/2023 7:22:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Store]    Script Date: 4/12/2023 7:22:59 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[AverageSalaryByDept] ([DepartmentID], [DepartmentName], [AvgSalary]) VALUES (1, N'Executive', CAST(391666.666666 AS Decimal(38, 6)))
GO
INSERT [dbo].[AverageSalaryByDept] ([DepartmentID], [DepartmentName], [AvgSalary]) VALUES (2, N'Finance', CAST(48804.600000 AS Decimal(38, 6)))
GO
INSERT [dbo].[AverageSalaryByDept] ([DepartmentID], [DepartmentName], [AvgSalary]) VALUES (3, N'Human Resources', CAST(49144.125000 AS Decimal(38, 6)))
GO
INSERT [dbo].[AverageSalaryByDept] ([DepartmentID], [DepartmentName], [AvgSalary]) VALUES (4, N'Marketing', CAST(47062.500000 AS Decimal(38, 6)))
GO
INSERT [dbo].[AverageSalaryByDept] ([DepartmentID], [DepartmentName], [AvgSalary]) VALUES (5, N'Purchasing', CAST(56082.800000 AS Decimal(38, 6)))
GO
...
GO
INSERT [dbo].[Employee] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [Active], [StoreID], [ManagerID], [Salary], [SalaryType], [DepartmentID]) VALUES (1, N'Pamelia', N'Jackson', N'pamelia.jackson@mystore.com', N'831-555-5554', 1, 1, NULL, CAST(1001000.00 AS Decimal(10, 2)), N'M', 1)
GO
INSERT [dbo].[Employee] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [Active], [StoreID], [ManagerID], [Salary], [SalaryType], [DepartmentID]) VALUES (2, N'Kasha', N'David', N'kasha.david@mystore.com', N'831-555-5555', 1, 1, 1, CAST(121000.00 AS Decimal(10, 2)), N'M', 1)
GO
...
GO
INSERT [dbo].[Employee] ([EmployeeID], [FirstName], [LastName], [Email], [Phone], [Active], [StoreID], [ManagerID], [Salary], [SalaryType], [DepartmentID]) VALUES (5, N'Ramesh', N'Singh', N'ramesh.singh@mystore.com', N'516-379-4444', 1, 2, 1, CAST(56000.00 AS Decimal(10, 2)), N'W', 1)
GO
...
GO
INSERT [dbo].[Sales] ([InvoiceID], [CustomerID], [SalesDate], [StoreID], [EmployeeID], [SalesAmount]) VALUES (21, 4, CAST(N'2022-06-02' AS Date), 1, 2, CAST(2121.00 AS Decimal(10, 2)))
GO
